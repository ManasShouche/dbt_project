...
SELECT
    RECORD_METADATA:topic::string               AS topic,
    COUNT(*)                                    AS rows_landed,
    MIN(TO_TIMESTAMP_NTZ(RECORD_METADATA:SnowflakeConnectorPushTime::bigint, 3)) AS first_ingested_at,
    MAX(TO_TIMESTAMP_NTZ(RECORD_METADATA:SnowflakeConnectorPushTime::bigint, 3)) AS last_ingested_at
